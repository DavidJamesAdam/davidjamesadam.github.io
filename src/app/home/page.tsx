          ...
          <div className="flex flex-col">
            <div className="m-5  md:text-lg">
              <p className="indent-[2em]">
                ...
                completed a 15 month internship with Gigadat Solutions, working
                on both QA and backend teams. I&apos;ve worked with backend
                frameworks such as FastAPI, Express, and Fastify, frontend
                frameworks such as React Router and Next.js, and databases such
                as PostgreSQL. I&apos;m also an electronics hobbiest, making
                gadgets out of micro-controllers, and I&apos;m always picking
                away at my homelab.
              </p>
            </div>
